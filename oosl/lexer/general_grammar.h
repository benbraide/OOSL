...
namespace oosl{
	namespace lexer{
		...
		public:
			...
			typedef boost::spirit::qi::rule<iterator_type, OOSL_AST_NAME(identifier)(), skipper> identifier_rule_type;

			identifier_grammar();

		protected:
			identifier_rule_type start_;
		};

		class global_qualified_grammar : public boost::spirit::qi::grammar<const char *, OOSL_AST_NAME(global_qualified)(), skipper>{
		public:
			typedef const char *iterator_type;
			typedef boost::spirit::qi::rule<iterator_type, OOSL_AST_NAME(global_qualified)(), skipper> global_qualified_rule_type;

			global_qualified_grammar();

		protected:
			global_qualified_rule_type start_;
		...
		public:
			typedef const char *iterator_type;
			typedef boost::spirit::qi::rule<iterator_type, OOSL_AST_NAME(recursive_qualified)(), skipper> recursive_qualified_rule_type;

			recursive_qualified_grammar();

		protected:
			recursive_qualified_rule_type start_;
			identifier_grammar identifier_;
		};
		...
		public:
			typedef const char *iterator_type;
			typedef boost::spirit::qi::rule<iterator_type, OOSL_AST_NAME(relative_qualified)(), skipper> relative_qualified_rule_type;

			relative_qualified_grammar();

		protected:
			relative_qualified_rule_type start_;
			identifier_grammar identifier_;
		...
		public:
			typedef const char *iterator_type;
			typedef boost::spirit::qi::rule<iterator_type, OOSL_AST_NAME(qualified)(), skipper> qualified_rule_type;

			qualified_grammar();

		protected:
			qualified_rule_type start_;
